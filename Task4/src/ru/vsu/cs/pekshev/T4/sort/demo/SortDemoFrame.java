...
import ru.vsu.cs.pekshev.T4.sort.*;
...
public class SortDemoFrame extends JFrame {
    ...
    public SortDemoFrame() {
        ...
        buttonHeapSort.addActionListener(actionEvent -> sortDemo(ShakerSort::sort));
        ...
        buttonPerformanceTest1.addActionListener(actionEvent -> {
            String[] sortNames = {
                    ...
                    "Шейкерная(Перемешиванием) (ShakerSort)",
            ...
            Consumer<Integer[]>[] sorts = new Consumer[]{
                    ...
                    (Consumer<Integer[]>) ShakerSort::sort,
            };
            int[] sizes = {
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        buttonHeapSort.setText("Шейкерная(перемешиванием) сортировка (ShakerSort)");
        panel2.add(buttonHeapSort, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        ...
        panel3.add(checkBoxPartiallyOrdered, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_EAST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
